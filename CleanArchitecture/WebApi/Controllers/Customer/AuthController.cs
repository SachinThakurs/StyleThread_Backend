...
namespace WebApi.Controllers.Product
{
    ...
    public class AuthController(IMediator _mediator) : ControllerBase
    {
        ...
        [HttpPost("Login")]
        public async Task<IActionResult> Login([FromBody] GenericCreateCommand<LoginRequestDto, GenericResponse<CustomerDto>> userCredentials, CancellationToken cancellationToken)
        {
